...
import { FilterDataItem, IDashboardPayload, StoreRoot, StoresInfo } from '@interfaces';
...
export const DashboardNodule = () => {
  ...
  return <AppDashboard payload={payload} setPayload={setPayload} storesFilterData={stores} />;
};
