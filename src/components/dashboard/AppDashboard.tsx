        ...
        <div className="filters mb-5">
          <div className="main-filters flex">
            <ShareSelectInput
              ...
              onChange={(value: any) => setPayload({ ...payload, filterTime: value })}
              placeholder="Time"
            ...
            <ShareSelectInput
              ...
              onChange={(value: any) => setPayload({ ...payload, filterStore: value })}
              placeholder="Store"
            ...
            <ShareSelectInput
              data={[]}
              onChange={(value: any) => setPayload({ ...payload, filterBranhGroup: value })}
